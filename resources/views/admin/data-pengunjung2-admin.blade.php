...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="data-pengunjung2-admin.css">
                  ...
                  <a class="nav-link" href="homepage_admin.html">Book</a>
                       ...
                       <li class="nav-item dropdown">
                         ...
                         <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                          <li><a href="profile_admin.html"class="dropdown-item" href="#">Admin</a></li>
                          <li><a href="loanhistory_admin.html" class="dropdown-item" href="#">Riwayat</a></li>
  ...
  <body>
    <div class="wrap">
         <table>
            ...
            <tr>
                <tr>
                    <td><b>Kelas </b></td><td>:</td> <td> XI IPA 1</td>
                </tr>
            <tr>
                <td><b>No Telp </b></td><td>:</td> <td>0822-1234-9023</td>
            </tr>
        </table>
        </center>
<br> <br>
